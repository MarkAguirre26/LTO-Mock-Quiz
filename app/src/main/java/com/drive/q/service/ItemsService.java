...
//        List<Item> questions = new ArrayList<>();
        ...
        items.add(new Item("Ang pagmamaneho ng PUV na may stereo-music ay may parusa na:	","multa na Php 1,000	","pagbawi ng lisensya at rehistro	","pagkakakulong ng drayber sa loob ng anim na buwan	","A"));
        ...
        items.add(new Item("Ang mahuhuling lasing sa alak o ipinagbabawal na gamot ay may parusang:	","Pagsuspinde ng lisensya	","Pagkabilanggo ng anim na buwan	","tama lahat ng sagot	","C"));
        ...
        items.add(new Item("Ang paggamit ng huwad na lisensya ay ipinagbabawal at may parusang:	","Php 1,500 at anim na buwan na hindi makakakuha ng lisensya	","Pagkakabilanggo ng hindi hihigit sa anim na buwan	","Php 100	","A"));
        items.add(new Item("Ang pagalit at aroganteng pakikitungo sa pasahero o otoridad ng drayber o kundoktor ng PUV ay may parusa na:	","multa na Php 500 at suspensyon ng lisensya	","pagkakulong ng anim na buwan	","suspension ng lisensya sa loob ng isang buwan	","A"));
